...
if (COMP_NAME STREQUAL elm)
  string(APPEND CMAKE_Fortran_FLAGS " -gpu:deepcopy,ptxinfo -Minfo=accel -acc -cuda")
endif()
...
string(APPEND CMAKE_EXE_LINKER_FLAGS " -Wl,--allow-multiple-definition -lstdc++ -acc -cuda")
